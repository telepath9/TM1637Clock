...
//SETUP NTP
    ...
    //cycle that waits 4 connection
      while (WiFi.status() != WL_CONNECTED ) {
           ...
           mydisplay.showNumberDecEx(0, 0, false, 1, 3);
           delay (200);
           mydisplay.showNumberDecEx(0, 0, false, 1, 2);
           delay (200);
           mydisplay.showNumberDecEx(0, 0, false, 1, 1);
           delay (200);
           mydisplay.showNumberDecEx(0, 0, false, 1, 0);
